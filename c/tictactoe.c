// tictactoe.c
// generate all boards, eliminate duplicates from rotations and mirrors
// build relationships among boards. If one board can reach another by
// filling one more cell, the former is a parent of the latter. The latter
// is a child of the former. Please notice that it is possible (likely)
// that a board has several parents and several children
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
#include "tictactoe.h"
